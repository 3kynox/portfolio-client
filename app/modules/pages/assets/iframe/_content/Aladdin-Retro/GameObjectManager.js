    ...
    */
    this.startupGameObjectManager = function()
    {
        ...
        new ResourceManager().startupResourceManager(
            [{name: 'runLeft', src: 'run-left.png'},
            {name: 'runRight', src: 'run-right.png'},
            {name: 'idleLeft', src: 'idle-left.png'},
            {name: 'idleRight', src: 'idle-right.png'},
            {name: 'background0', src: 'a_back_001.png' },
            {name: 'background1', src: 'a_main_000.png' },
            {name: 'background2', src: 'a_front_001.png' },
