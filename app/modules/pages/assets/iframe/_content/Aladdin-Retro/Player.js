...
function Player() 
{
    this.jump = new Audio("jump_01.mp3");
    ...
    */
    ...
    {
        this.startupAnimatedGameObject(g_ResourceManager.idleRight, 70, 285, 3, 1, 20);
        this.level = level;
        return this;
    }
    ...
    */
    this.keyDown = function (event) {
        ...
        if (event.keyCode == 32 && this.grounded) {
            this.grounded = false;
            this.jumpSinWavePos = 0;
            // jump sound, disabled cause laggy
            // this.jump.play();
        }
    ...
    */
	this.update = function (/**Number*/ dt, /**CanvasRenderingContext2D*/context, /**Number*/ xScroll, /**Number*/ yScroll)
    {
        ...
        // modify the xScroll value to keep the player on the screen
        if (this.x > context.canvas.width / 2)
            g_GameObjectManager.xScroll = this.x - context.canvas.width / 2;
        if (this.x < xScroll)
